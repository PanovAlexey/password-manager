...
func (s *StorageHandler) GetBinaryRecordById(ctx context.Context, request *pb.GetBinaryRecordByIdRequest) (*pb.GetBinaryRecordByIdResponse, error) {
	...
	s.logger.Info("successful got binary record by id. ", request)
