...
func (s *StorageHandler) UpdateCreditCard(ctx context.Context, request *pb.UpdateCreditCardByIdRequest) (*pb.UpdateCreditCardByIdResponse, error) {
	...
	s.logger.Info("successful updated credit card. ", request)
