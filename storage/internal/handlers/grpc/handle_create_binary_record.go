...
func (s *StorageHandler) CreateBinaryRecord(ctx context.Context, request *pb.CreateBinaryRecordRequest) (*pb.CreateBinaryRecordResponse, error) {
	...
	s.logger.Info("successful created binary record. ", request)
