...
var file_proto_user_data_manager_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0xde, 0x04, 0x0a, 0x0f, 0x55, 0x73,
	...
	0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x42, 0x1c, 0x5a, 0x1a, 0x70, 0x6b,
	0x67, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x6d, 0x61, 0x6e, 0x61,
	0x67, 0x65, 0x72, 0x5f, 0x67, 0x72, 0x70, 0x63, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_proto_user_data_manager_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
...
var file_proto_user_data_manager_proto_depIdxs = []int32{
	12, // 0: user_data_manager.ProtectedItem.created_date:type_name -> google.protobuf.Timestamp
	12, // 1: user_data_manager.ProtectedItem.last_access:type_name -> google.protobuf.Timestamp
	12, // 2: user_data_manager.LoginPassword.created_date:type_name -> google.protobuf.Timestamp
	12, // 3: user_data_manager.LoginPassword.last_access:type_name -> google.protobuf.Timestamp
	...
	3,  // 10: user_data_manager.UserDataManager.GetLoginPasswordList:input_type -> user_data_manager.GetLoginPasswordListRequest
	5,  // 11: user_data_manager.UserDataManager.CreateLoginPassword:input_type -> user_data_manager.CreateLoginPasswordRequest
	7,  // 12: user_data_manager.UserDataManager.GetLoginPasswordById:input_type -> user_data_manager.GetLoginPasswordByIdRequest
	9,  // 13: user_data_manager.UserDataManager.PatchLoginPasswordById:input_type -> user_data_manager.PatchLoginPasswordByIdRequest
	11, // 14: user_data_manager.UserDataManager.DeleteLoginPasswordById:input_type -> user_data_manager.DeleteLoginPasswordByIdRequest
	4,  // 15: user_data_manager.UserDataManager.GetLoginPasswordList:output_type -> user_data_manager.GetLoginPasswordListResponse
	6,  // 16: user_data_manager.UserDataManager.CreateLoginPassword:output_type -> user_data_manager.CreateLoginPasswordResponse
	8,  // 17: user_data_manager.UserDataManager.GetLoginPasswordById:output_type -> user_data_manager.GetLoginPasswordByIdResponse
	10, // 18: user_data_manager.UserDataManager.PatchLoginPasswordById:output_type -> user_data_manager.PatchLoginPasswordByIdResponse
	13, // 19: user_data_manager.UserDataManager.DeleteLoginPasswordById:output_type -> google.protobuf.Empty
